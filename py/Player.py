...
class Player:
	...
	def _mouse_dir(self) -> Vector:
		direction = Vector(*self._pos) - Vector(*pygame.mouse.get_pos())
	...
	def draw(self, surface : pygame.Surface) -> None:
		...
		surface.blit(*rotate_img_center(self._sprite, self._pos.tuple_2D, self._angle + 10))
	
	def update(self) -> None:
		self._angle = self._mouse_dir.argument()
